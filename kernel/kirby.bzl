...
def define_kirby():
    _kirby_in_tree_modules = [
        ...
        "drivers/input/touchscreen/NT36XXX_SPI/nvt_36xxx.ko",
        ...
        "drivers/misc/lenovo-bl-booster.ko",
        "drivers/misc/qseecom_proxy.ko",
        "drivers/misc/hqsysfs/hqsysfs.ko",
        ...
        "drivers/thermal/lenovo_thermal_control.ko",
        "drivers/thermal/lenovo_sys_temp.ko",
        "drivers/tty/hvc/hvc_gunyah.ko",
        "drivers/tty/serial/msm_geni_serial.ko",
    "drivers/tty/serial/lenovo_keyboard/lenovo_keyboard.ko",
        ...
        "drivers/soc/qcom/fsa4480-sub-i2c.ko",
        ...
        "drivers/input/haptic86937/haptic.ko",
        ...
        "drivers/regulator/aw3750x.ko",
        "sound/soc/codecs/snd-soc-hdmi-codec.ko",
        "sound/usb/snd-usb-audio-qmi.ko",
    ]

    _kirby_consolidate_in_tree_modules = _kirby_in_tree_modules + [
        # keep sorted
    ...
    for variant in la_variants:
        ...
        if variant == "consolidate":
            mod_list = _kirby_consolidate_in_tree_modules
        else:
            mod_list = _kirby_in_tree_modules
