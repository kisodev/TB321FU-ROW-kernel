...
def define_lapis():
    ...
    "drivers/tty/serial/lenovo_keyboard/lenovo_keyboard.ko",
        ...
        "drivers/input/hall/hall_mod.ko",
        "sound/soc/codecs/snd-soc-hdmi-codec.ko",
        "sound/usb/snd-usb-audio-qmi.ko",
    ]

    _lapis_consolidate_in_tree_modules = _lapis_in_tree_modules + [
        # keep sorted
    ...
    for variant in la_variants:
        ...
        if variant == "consolidate":
            mod_list = _lapis_consolidate_in_tree_modules
        else:
            mod_list = _lapis_in_tree_modules
